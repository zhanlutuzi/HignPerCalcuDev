...
namespace EX13_Pro2
{
    class Program
    {
        ...
        {
            string url1 = @"D:\Desktop\code\Learning\HignPerCalcuDev\HignPerCalcuDev\EX13\data\13-3.tif";
            string url2 = "gdbp://MapGISLocalPlus/sample/ras/13-3";
            string frm = "GTiff";
        ...
        {
            string url3 = @"D:\Desktop\code\Learning\HignPerCalcuDev\HignPerCalcuDev\EX13\result\13-3.tif";
            string url4 = "gdbp://MapGISLocalPlus/sample/ras/13-3";
            string frm1 = "GTiff";
